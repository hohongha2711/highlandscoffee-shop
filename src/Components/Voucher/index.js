      ...
      <div className="list-voucher">
        <div className="voucher-item">
          <div className="voucher-item_inner">
            ...
            <div className="copy_discount">
              <p className="code_zip">12VC30K</p>
              <button className="btn dis_copy_2" data-copy="12VC30K">
                <span>Lưu</span>
              </button>
            </div>
          </div>
        ...
        <div className="voucher-item">
          <div className="voucher-item_inner">
            ...
            <div className="copy_discount">
              <p className="code_zip">12VC50K</p>
              <button className="btn dis_copy_2" data-copy="12VC30K">
                <span>Lưu</span>
              </button>
            </div>
        ...
        <div className="voucher-item">
          <div className="voucher-item_inner">
            ...
            <div className="copy_discount">
              <p className="code_zip">12VC100K</p>
              <button className="btn dis_copy_2" data-copy="12VC30K">
                <span>Lưu</span>
              </button>
            </div>
